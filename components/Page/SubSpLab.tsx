import {
  ...
  const SubSpLab = ({navigation, route}) => {
    ...
    useEffect(() => {
      const fetchData = async () => {
        try {
          const response = await fetch(`http://innov8ture.pythonanywhere.com/api/attendance?srn=${text}&subject=SP_LAB`);
