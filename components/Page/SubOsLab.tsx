import {
  ...
  const SubOsLab = ({navigation, route}) => {
    ...
    useEffect(() => {
      const fetchData = async () => {
        try {
          const response = await fetch(`http://innov8ture.pythonanywhere.com/api/attendance?srn=${text}&subject=OS_LAB`);
